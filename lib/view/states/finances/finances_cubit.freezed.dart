...
/// Adds pattern-matching-related methods to [FinancesState].
extension FinancesStatePatterns on FinancesState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( FinancesViewModel content)?  content,TResult Function( Exception error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Loading() when loading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( FinancesViewModel content)  content,required TResult Function( Exception error)  error,}) {final _that = this;
switch (_that) {
case Loading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( FinancesViewModel content)?  content,TResult? Function( Exception error)?  error,}) {final _that = this;
switch (_that) {
case Loading() when loading != null:
return loading();case Content() when content != null:
return content(_that.content);case CustomError() when error != null:
