...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( AnalysisViewModel content,  AnalysisViewModel? previousContent)?  content,TResult Function( Exception error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Loading() when loading != null:
return loading();case Content() when content != null:
return content(_that.content,_that.previousContent);case CustomError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( AnalysisViewModel content,  AnalysisViewModel? previousContent)  content,required TResult Function( Exception error)  error,}) {final _that = this;
switch (_that) {
case Loading():
return loading();case Content():
return content(_that.content,_that.previousContent);case CustomError():
return error(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( AnalysisViewModel content,  AnalysisViewModel? previousContent)?  content,TResult? Function( Exception error)?  error,}) {final _that = this;
switch (_that) {
case Loading() when loading != null:
return loading();case Content() when content != null:
return content(_that.content,_that.previousContent);case CustomError() when error != null:
